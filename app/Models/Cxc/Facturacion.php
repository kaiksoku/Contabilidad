...
class Facturacion extends Model
{
    ...
    'ven_empresa','ven_terminal','ven_correlativoInt','ven_enlacefactura','ven_referencia',
    'ven_anulada'];
  ...
  public static function getFacturas($emp)
    ...
    public function getUUID($empid){
        $factura = new Facturacion();
        return $factura->where('ven_id',$empid)->first()->ven_iiud;
    }

    public function getFecha($empid){
        $fechaCert = new Facturacion();
        return $fechaCert->where('ven_id',$empid)->first()->ven_fechaCert;
    }

    public function getNumDoc($empid){
        $numD = new Facturacion();
        return $numD->where('ven_id',$empid)->first()->ven_numDoc;
    }


    public function getSerie($empid){
        $serie = new Facturacion();
        return $serie->where('ven_id',$empid)->first()->ven_serie;
    }
