...
class ValidacionFacturacion extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'ven_enlacefactura'=>'max:200',
            'ven_referencia'=>'max:100',
            'tipofactura'=>'max:1',
    ...
    public function attributes()
    {
        return [
            ...
            'ven_enlacefactura'=>'<strong>URL Factura</strong>',
            'ven_referencia'=>'<strong>Referencia de Factura</strong>',
            'tipofactura'=>'<strong>Tipo Factura</strong>',
