...
@section('breadcrumbs')
{{ Breadcrumbs::render('empresa.terminal',$data) }}
@endsection

@section('scripts')
<script src="{{asset("assets/pages/scripts/parametros/empresa/terminal.js")}}" type="text/javascript"></script>
@endsection
            ...
            <div class="col-lg-12">
                ...
                <div class="card card-outline card-info">
                    <div class="card-header">
                        <h3 class="card-title">Asignar Terminales a <small>{{$data->emp_nombre}}</small></h3>
                    ...
                    <div class="card-body">
                        @csrf
                        <input type="hidden" id="empresa" name="empresa" value="{{$data->emp_id}}">
