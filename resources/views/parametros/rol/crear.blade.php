...
@section('breadcrumbs')
{{ Breadcrumbs::render('rol.crear') }}
@endsection

@section('scripts')
<script src="{{asset("assets/pages/scripts/parametros/crear.js")}}" type="text/javascript"></script>
@endsection
            ...
            <div class="col-lg-12">
                ...
                <div class="card card-outline card-success">
                    <div class="card-header">
                        <h3 class="card-title">Crear Rol<small></small></h3>
