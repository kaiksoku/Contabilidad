                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-outline card-success">
                        <div class="card-header">
                            <h3 class="card-title">Crear Empleados<small></small></h3>
                            <div class="card-tools">
                                <a href="{{route('empleados')}}" class="btn btn-block btn-info btn-sm">Volver a
                                    Listado<i class="fas fa-arrow-circle-left pl-1"></i></a>
                            </div>
                        </div>
                        <form action="{{route('empleados.guardar')}}" id="form-general" class="form-horizontal" onsubmit="setIdioma();setNit()" autocomplete="off"
                              method="POST">
                            @csrf
