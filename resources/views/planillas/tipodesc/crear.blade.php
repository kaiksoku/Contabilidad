...
@section("titulo")
    Crear Tipos Descuentos y Bonificaciones
@endsection
...
@section('breadcrumbs')
    {{ Breadcrumbs::render('tipodesc.crear') }}
@endsection
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-outline card-success">
                        <div class="card-header">
                            <h3 class="card-title"><small>Tipos Descuentos y Bonificaciones</small></h3>
                            <div class="card-tools">
                                <a href="{{route('tipodesc')}}" class="btn btn-block btn-info btn-sm">Volver a
                                    Listado<i class="fas fa-arrow-circle-left pl-1"></i></a>
                            </div>
                        </div>
                        <form action="{{route('tipodesc.guardar')}}" id="form-general" class="form-horizontal"  autocomplete="off"
                              method="POST">
                            @csrf
                            <div class="card-body">
