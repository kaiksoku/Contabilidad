...
@section("titulo")
    Generacion de Planilla Especial
@endsection
...
@section('breadcrumbs')
    {{ Breadcrumbs::render('planillas-especial.crear') }}
@endsection
                    ...
                    <div class="card card-outline card-success">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{route('planillas-mensual')}}"
                                   class="btn btn-block btn-info btn-sm">Volver a Listado<i
                                        class="fas fa-arrow-circle-left pl-1"></i></a>
                            </div>
                        </div>
                        <form action="{{route('planillas-especial.guardar')}}" id="form-general" class="form-horizontal"
                              autocomplete="off"
                              method="POST">
                            @csrf

                            <div class="card-body">
                                @include('planillas.generacion.especial.form')
                            </div>
                            <!-- /.card-body -->
