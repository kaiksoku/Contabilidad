...
@section('breadcrumbs')
{{ Breadcrumbs::render('amortizaciones') }}
@endsection
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-outline card-info">
                        <div class="card-header">
                            <h3 class="card-title">Amortizaciones <small></small></h3>
                            <div class="card-tools">
                            @can('crear activos/amortizacion')
                                <a href="{{route('amortizaciones.crear')}}" class="btn btn-block btn-success btn-sm">
                                Nuevo registro<i class="fa fa-fw fa-plus-circle pl-1"></i></a>
                                @else
                                <a href="{{route('amortizaciones.crear')}}" class="btn btn-block btn-success btn-sm disabled">
                                Nuevo registro<i class="fa fa-fw fa-plus-circle pl-1"></i></a>
                            @endcan
                            </div>
                        </div>
                        <div class="card-body">
                            <table class="table table-striped table-hover" id="tabla-data">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{$data->cam_descripcion}}</td>
                                        <td>{{$data->Empresa->emp_siglas}}</td>
                                        <td>{{$data->Terminal->ter_abreviatura}}</td>
                                        <td>{{Str::money($data->cam_monto,'Q.')}}</td>
                                        <td>
                                          <!--  @can('actualizar activos/amortizacion')
                                            <a href="{{route('amortizaciones.editar',['id'=> $data->cam_id])}}"
                                            ...
                                            <a href="{{route('amortizaciones.editar',['id'=> $data->cam_id])}}"
                                                ...
                                                <i class="far fa-edit"></i></a>
                                            @endcan
                                            @can('eliminar activos/amortizacion')
                                            <a href="{{route('amortizaciones.eliminar',['id'=> $data->cam_id])}}"
                                            ...
                                            <a href="{{route('amortizaciones.eliminar',['id'=> $data->cam_id])}}"
                                                ...
                                                <i class="text-danger far fa-trash-alt"></i></a>
                                            @endcan -->
                                            <a href="{{route('amortizaciones.mostrar',['id'=> $data->cam_id])}}"
