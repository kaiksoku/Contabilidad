...
@section('breadcrumbs')
    {{ Breadcrumbs::render('debito.crear') }}
@endsection
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-outline card-success">
                        <div class="card-header">
                            <h3 class="card-title">Formulario de Débito<small></small></h3>
                            <div class="card-tools">
                                <a href="{{route('debito')}}" class="btn btn-block btn-info btn-sm">
                                    Volver a Débitos<i class="fas fa-arrow-circle-left pl-1"></i></a>
                            </div>
                        </div>

                        <form action="{{route('debito.guardar')}}" class="form-horizontal" method="post" id="form-general" method="post" autocomplete="off">
