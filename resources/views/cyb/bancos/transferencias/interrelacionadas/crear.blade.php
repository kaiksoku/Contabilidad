...
@section('breadcrumbs')
    {{ Breadcrumbs::render('relacionadas.crear') }}
@endsection
@section('contenido')
                    ...
                    <div class="card card-outline card-success">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{route('relacionadas')}}" class="btn btn-block btn-info btn-sm">
                                    Regresar a la Lista<i class="fas fa-arrow-circle-left pl-1"></i></a>
                            </div>
                        </div>
                    <br>
                        <form action="{{route('derelacionadas.crear')}}" class="form-horizontal">
                            <div class="row">
                        ...
                        <form action="{{route('relacionadas.guardar')}}" class="form-horizontal" method="post"
                              id="form-general" autocomplete="off">
                            <input type="hidden" id="ctaPath" value="{{url('cyb/bancos/transferencias/filtro')}}">
                            <input type="hidden" id="empPath" value="{{url('cyb/bancos/transferencias/empresa/filtro')}}">
                                ...
                                <fieldset class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12 col-lg-6">
                                            <fieldset class="border p-2 col-sm-12 col-lg-12">
                                                <legend class="w-auto"><strong>Cuenta a Debitar</strong></legend>
                                        ...
                                        <div class="col-sm-12 col-lg-6">
                                            <fieldset class="border p-2 col-sm-12 col-lg-12">
                                                <legend class="w-auto"><strong>Empresa a Acreditar</strong></legend>

                                                <div class="form-group row">
                                                    <label for="inputempresacre" class="col-sm-12 col-lg-2 control-label text-sm-left text-lg-right requerido">Empresa</label>
                                                    <div class="col-sm-12 col-lg-10">
                                                        <select name="empresaacreditar" class="form-control select2" id="inputempresados"required>
                                                            <option value="">Seleccione la Empresa</option>
                                    ...
                                    <fieldset class="border p-2 col-sm-12 col-lg-12">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12 col-lg-4">
                                                <input name="che_tipo" type="text" class="form-control" hidden required
                                                       value="TR">
                                            </div>
                                        </div>
