            ...
            <div class="col-lg-12">
                ...
                <div class="card card-outline card-success">
                    <div class="card-header">
                        ...
                        <form action="{{route('anticipos.guardarFU')}}" class="form-horizontal" method="post" id="form-general">
                            <div class="card-body">
                            ...
                            <input type="hidden" id="codigoterminal" value="{{old('che_terminal')}}">
                                ...
                                <div class="form-group row">
                                    <label for="per_nit"
                                        class="col-sm-12 col-lg-2 control-label text-sm-left text-lg-right requerido">Facturas</label>
                                    <div class="col-sm-12 col-lg-4">
