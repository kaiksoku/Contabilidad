            ...
            <div class="col-lg-12">
                ...
                <div class="card card-outline card-info">
                    <div class="card-header">
                        <h3 class="card-title">Clave <small></small></h3>
                        <div class="card-tools">
                            @can('crear admin/clave')
                            <a href="{{route('clave.crear')}}" class="btn btn-block btn-success btn-sm">
                                Nuevo registro<i class="fa fa-fw fa-plus-circle pl-1"></i></a>
                            @else
                            <a href="{{route('clave.crear')}}" class="btn btn-block btn-success btn-sm disabled">
                                Nuevo registro<i class="fa fa-fw fa-plus-circle pl-1"></i></a>
                            @endcan
                        ...
                        <table class="table table-striped table-hover" id="tabla-data">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @can('actualizar admin/clave')
                                        <a href="{{route('clave.editar',['id'=> $data->cla_empresa])}}"
                                        ...
                                        <a href="{{route('clave.editar',['id'=> $data->cla_empresa])}}"
                                            ...
                                            <i class="far fa-edit"></i></a>
                                        @endcan
                                        @can('eliminar admin/clave')
                                        <a href="{{route('clave.eliminar',['id'=> $data->cla_empresa])}}"
                                        ...
                                        <a href="{{route('clave.mostrar',['id'=>$data->cla_empresa])}}"
