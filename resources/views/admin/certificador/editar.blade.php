...
@section('breadcrumbs')
{{ Breadcrumbs::render('certificador.editar', $data) }}
@endsection
            ...
            <div class="col-lg-12">
                ...
                <div class="card card-outline card-success">
                    <div class="card-header">
                        <h3 class="card-title">Editar Certificador <small>{{$data->cer_nombre}}</small></h3>
                        <div class="card-tools">
                            <a href="{{route('certificador')}}" class="btn btn-block btn-info btn-sm">
                                Volver a Listado<i class="fas fa-arrow-circle-left pl-1"></i></a>
                        </div>
                    </div>
                    <form action="{{route('certificador.actualizar',['id'=>$data->cer_id])}}" id="form-general" class="form-horizontal" method="POST"
                        autocomplete="off">
                        <div class="card-body">
                            @method('put')
                            @csrf
