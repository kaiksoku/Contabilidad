            ...
            <div class="col-lg-12">
                ...
                <div class="card card-outline card-info">
                    <div class="card-header">
                        <h3 class="card-title">Nivel Académico <small></small></h3>
                        <div class="card-tools">
                            @can('crear admin/academico')
                            <a href="{{route('academico.crear')}}" class="btn btn-block btn-success btn-sm">
                                Nuevo registro<i class="fa fa-fw fa-plus-circle pl-1"></i></a>
                            @else
                            <a href="{{route('academico.crear')}}" class="btn btn-block btn-success btn-sm disabled">
                                Nuevo registro<i class="fa fa-fw fa-plus-circle pl-1"></i></a>
                            @endcan
                        </div>
                    </div>
                    <div class="card-body">
                        <table class="table table-striped table-hover" id="tabla-data">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$data->aca_id}}</td>
                                    <td>{{$data->aca_descripcion}}</td>
                                    <td>
                                        @can('actualizar admin/academico')
                                        <a href="{{route('academico.editar',['id'=> $data->aca_id])}}"
                                        ...
                                        <a href="{{route('academico.editar',['id'=> $data->aca_id])}}"
                                            ...
                                            <i class="far fa-edit"></i></a>
                                        @endcan
                                        @can('eliminar admin/academico')
                                        <a href="{{route('academico.eliminar',['id'=> $data->aca_id])}}"
