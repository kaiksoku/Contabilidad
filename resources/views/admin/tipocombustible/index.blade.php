...
@section('breadcrumbs')
{{ Breadcrumbs::render('tipocombustible') }}
@endsection
            ...
            <div class="col-lg-12">
                ...
                <div class="card card-outline card-info">
                    <div class="card-header">
                        <h3 class="card-title">Tipo de Combustible <small></small></h3>
                        <div class="card-tools">
                            @can('crear admin/tipocombustible')
                            <a href="{{route('tipocombustible.crear')}}" class="btn btn-block btn-success btn-sm">
                                Nuevo registro<i class="fa fa-fw fa-plus-circle pl-1"></i></a>
                            @else
                            <a href="{{route('tipocombustible.crear')}}"
                    ...
                    <div class="card-body">
                        <table class="table table-striped table-hover" id="tabla-data">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$data->tco_nombre}}</td>
                                    <td>{{Str::money($data->tco_idp,'Q.')}}</td>
                                    <td>
                                        @can('actualizar admin/tipocombustible')
                                        <a href="{{route('tipocombustible.editar',['id'=> $data->tco_id])}}"
                                        ...
                                        <a href="{{route('tipocombustible.editar',['id'=> $data->tco_id])}}"
                                            ...
                                            <i class="far fa-edit"></i></a>
                                        @endcan
                                        @can('eliminar admin/tipocombustible')
                                        <a href="{{route('tipocombustible.eliminar',['id'=> $data->tco_id])}}"
