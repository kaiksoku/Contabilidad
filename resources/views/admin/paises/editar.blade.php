...
@section('breadcrumbs')
{{ Breadcrumbs::render('paises.editar', $data) }}
@endsection
            ...
            <div class="col-lg-12">
                ...
                <div class="card card-outline card-success">
                    <div class="card-header">
                        <h3 class="card-title">Editar País <small>{{$data->pai_descripcion}}</small></h3>
                        <div class="card-tools">
                            <a href="{{route('paises')}}" class="btn btn-block btn-info btn-sm">
                                Volver a Listado<i class="fas fa-arrow-circle-left pl-1"></i></a>
                        </div>
                    </div>
                    <form action="{{route('paises.actualizar',['id'=>$data->pai_id])}}" id="form-general" class="form-horizontal" method="POST"
                        autocomplete="off">
                        <div class="card-body">
                            @method('put')
                            @csrf
