            ...
            <div class="col-lg-12">
                ...
                <div class="card card-outline card-info">
                    <div class="card-header">
                        <h3 class="card-title">País <small></small></h3>
                        <div class="card-tools">
                            @can('crear admin/paises')
                            <a href="{{route('paises.crear')}}" class="btn btn-block btn-success btn-sm">
                                Nuevo registro<i class="fa fa-fw fa-plus-circle pl-1"></i></a>
                            @else
                            <a href="{{route('paises.crear')}}" class="btn btn-block btn-success btn-sm disabled">
                                Nuevo registro<i class="fa fa-fw fa-plus-circle pl-1"></i></a>
                            @endcan
                        </div>
                    </div>
                    <div class="card-body">
                        <table class="table table-striped table-hover" id="tabla-data">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$data->pai_id}}</td>
                                    <td>{{$data->pai_descripcion}}</td>
                                    <td>
                                        @can('actualizar admin/paises')
                                        <a href="{{route('paises.editar',['id'=> $data->pai_id])}}"
                                        ...
                                        <a href="{{route('paises.editar',['id'=> $data->pai_id])}}"
                                            ...
                                            <i class="far fa-edit"></i></a>
                                        @endcan
                                        @can('eliminar admin/paises')
                                        <a href="{{route('paises.eliminar',['id'=> $data->pai_id])}}"
