...
@section('breadcrumbs')
{{ Breadcrumbs::render('tiposrepresentante') }}
@endsection
            ...
            <div class="col-lg-12">
                ...
                <div class="card card-outline card-info">
                    <div class="card-header">
                        <h3 class="card-title">Tipo de Representante<small></small></h3>
                        <div class="card-tools">
                            @can('crear admin/tiposrepresentante')
                            <a href="{{route('tiposrepresentante.crear')}}" class="btn btn-block btn-success btn-sm">
                                Nuevo registro<i class="fa fa-fw fa-plus-circle pl-1"></i></a>
                            @else
                            <a href="{{route('tiposrepresentante.crear')}}"
                    ...
                    <div class="card-body">
                        <table class="table table-striped table-hover" id="tabla-data">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$data->trep_nombre}}</td>
                                    <td>
                                        @can('actualizar admin/tiposrepresentante')
                                        <a href="{{route('tiposrepresentante.editar',['id'=> $data->trep_id])}}"
                                        ...
                                        <a href="{{route('tiposrepresentante.editar',['id'=> $data->trep_id])}}"
                                            ...
                                            <i class="far fa-edit"></i></a>
                                        @endcan
                                        @can('eliminar admin/tiposrepresentante')
                                        <a href="{{route('tiposrepresentante.eliminar',['id'=> $data->trep_id])}}"
