            ...
            <div class="col-lg-12">
                ...
                <div class="card card-outline card-info">
                    <div class="card-header">
                        <h3 class="card-title">Régimen <small></small></h3>
                        <div class="card-tools">
                            @can('crear admin/regimen')
                            <a href="{{route('regimen.crear')}}" class="btn btn-block btn-success btn-sm">
                                Nuevo registro<i class="fa fa-fw fa-plus-circle pl-1"></i></a>
                            @else
                            <a href="{{route('regimen.crear')}}" class="btn btn-block btn-success btn-sm disabled">
                                Nuevo registro<i class="fa fa-fw fa-plus-circle pl-1"></i></a>
                            @endcan
                        </div>
                    </div>
                    <div class="card-body">
                        <table class="table table-striped table-hover" id="tabla-data">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$data->reg_descripcion}}</td>
                                    <td>{{$data->reg_desc_ct}}</td>
                                    <td>
                                        @can('actualizar admin/regimen ')
                                        <a href="{{route('regimen.editar',['id'=> $data->reg_id])}}"
                                        ...
                                        <a href="{{route('regimen.editar',['id'=> $data->reg_id])}}"
                                            ...
                                            <i class="far fa-edit"></i></a>
                                        @endcan
                                        @can('eliminar admin/regimen ')
                                        <a href="{{route('regimen.eliminar',['id'=> $data->reg_id])}}"
