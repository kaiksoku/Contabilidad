...
@section('breadcrumbs')
{{ Breadcrumbs::render('clientes.crear') }}
@endsection

@section('scripts')
<script src="{{asset("assets/pages/scripts/cxc/clientes/crear.js")}}" type="text/javascript"></script>
            ...
            <div class="col-lg-12">
                ...
                <div class="card card-outline card-success">
                    <div class="card-header">
                        <h3 class="card-title">Crear Clientes<small></small></h3>
