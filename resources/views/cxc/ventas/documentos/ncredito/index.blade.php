            ...
            <div class="col-lg-12">
                ...
                <div class="card card-outline card-info">
                    <div class="card-header">
                        <h3 class="card-title">Nota de Credito <small></small></h3>
                        <div class="card-tools">
                            @can('crear cxc/ventas/documentos/ncredito')
                            <a href="{{route('ncredito.crear')}}" class="btn btn-block btn-success btn-sm">
                                Nuevo registro<i class="fa fa-fw fa-plus-circle pl-1"></i></a>
                            @else
                            <a href="{{route('ncredito.crear')}}" class="btn btn-block btn-success btn-sm disabled">
                                Nuevo registro<i class="fa fa-fw fa-plus-circle pl-1"></i></a>
                            @endcan
                        ...
                        <table class="table table-striped table-hover" id="tabla-data">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    @if($data->cer_nombre=='PAPEL')
                                        <a href="{{route('ncredito.mostrar',['id'=>$data->ven_id])}}"
                                   ...
                                   @else
                                            ...
                                            <a href="{{route('ncredito.editar',['id'=> $data->ven_id])}}"
                                                class="btn-accion-tabla mr-4"  data-toggle="tooltip"
                                                title="QR Nota Crédito">
                                                <i class="fas fa-qrcode"></i></a>
                                            @else
                                            <a href="{{route('nabono.editar',['id'=> $data->ven_id])}}"
                                                class="btn-accion-tabla mr-4 disabled" data-toggle="tooltip"
                                                title="QR Nota de Crédio">
                                                <i class="fas fa-qrcode"></i></a>
