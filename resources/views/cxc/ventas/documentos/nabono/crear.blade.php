...
@endsection
 ...
 @section('breadcrumbs')
{{ Breadcrumbs::render('nabono.crear') }}
@endsection
            ...
            <div class="col-lg-12">
                ...
                <div class="card card-outline card-success">
                    <div class="card-header">
                        <h3 class="card-title">Crear Nota de Abono<small></small></h3>
                        <div class="card-tools">
                            <a href="{{route('nabono')}}" class="btn btn-block btn-info btn-sm">
                                Volver a Listado<i class="fas fa-arrow-circle-left pl-1"></i></a>
                        </div>
                    </div>
                    <form action="{{route('nabono')}}" id="form-general" class="form-horizontal" method="POST"
                        autocomplete="off">
                        <div class="card-body">
                            @csrf
                            @include('cxc.ventas.documentos.nabono.form')
                        </div>
                        <!-- /.card-body -->
