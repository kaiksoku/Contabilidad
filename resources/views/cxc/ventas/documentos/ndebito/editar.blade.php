...
@section('breadcrumbs')
{{ Breadcrumbs::render('ndebito.editar', $data) }}
@endsection
            ...
            <div class="col-lg-12">
                ...
                <div class="card card-outline card-success">
                    <div class="card-header">
                        <h3 class="card-title">Código QR y Enlace de Nota de Débito <small>{{$data->ven_id}}</small></h3>
                    ...
                    <form action="{{route('nabono.actualizar',['id'=>$data->ven_id])}}" id="form-general" class="form-horizontal" method="POST"
                        ...
                        <div class="card-body">
                            @method('put')
                            @csrf
                            @include('cxc.ventas.documentos.ndebito.qr')
                        </div>
                        <!-- /.card-body -->
