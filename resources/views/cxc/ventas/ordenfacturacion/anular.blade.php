...
<script src="{{asset("assets/pages/scripts/cxc/factura/orden.js")}}" type="text/javascript"></script>
            ...
            <div class="col-lg-12">
                ...
                <div class="card card-outline card-success">
                    <div class="card-header">
                        <h3 class="card-title">Anular Orden de Facturación<small></small></h3>
                        <div class="card-tools">
                            <a href="{{route('ordenfacturacion')}}" class="btn btn-block btn-info btn-sm">
                                Volver a Listado<i class="fas fa-arrow-circle-left pl-1"></i></a>
                        </div>
                    </div>
                    <form action="{{route('ordenfacturacion.cancelar',['id'=>$data->ordf_id])}}" id="form-general" class="form-horizontal" method="POST"
                        autocomplete="off">
                        <div class="card-body">
                            @method('put')
                            @csrf
                               @include('cxc.ventas.ordenfacturacion.anulacion')
                        </div>
                        <!-- /.card-body -->
