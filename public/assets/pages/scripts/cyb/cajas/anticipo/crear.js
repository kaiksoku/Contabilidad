$('#inputfechaanticipo').daterangepicker({
...
$(function() {
    ...
    $("#inputbeneficiario").change(function() {
        let prueba=$('#inputbeneficiario :selected').text()
        if(prueba==='No aplica'){
            $('#beneficiario').show()
        }else{
            $('#beneficiario').hide()
...
$("#inputcuentabancaria").on("change", function (event) {
    ...
    const path = $("#empPath").val() + "/" + event.target.value ;
